  ...
  return (
    <div className="fixed w-full h-screen z-50">
      <div
        ...
        onClick={onClose}
      />
      <Card className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-11/12 max-w-4xl shadow-lg bg-white overflow-y-auto max-h-[90vh]">
        <CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6 md:space-y-0">
                ...
                {!file ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 flex flex-col items-center gap-3">
                      <div
                        className="relative w-full aspect-square max-w-xs flex-shrink-0"
                        style={{
                          backgroundImage:
