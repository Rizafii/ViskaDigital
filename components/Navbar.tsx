    ...
    <nav className="w-full fixed top-0 left-0 z-50">
      <div className="w-full py-6 mx-auto px-6 sm:px-12 lg:px-26 container flex bg-gradient-to-b from-black to-transparent justify-between items-center ">
        ...
        <div className="cta flex items-center gap-3 ">
          <Link
            href={"#"}
            className="lg:flex items-center gap-1 hidden duration-200 ease-in-out transition-all  hover:text-primary font-semibold text-xs bg-white px-4 py-3 rounded-full truncate"
          >
          ...
          <Link
            href={"#"}
            className="flex items-center gap-1 font-semibold text-sm bg-white self-stretch aspect-square rounded-full px-3"
          >
