    ...
    <nav className="w-full fixed top-0 left-0 z-50">
      <div className="w-full py-6 mx-auto px-4 sm:px-12 lg:px-26 container flex  justify-between items-center ">
        ...
        <div className="cta flex items-center gap-3 ">
          <Link
            href={"#"}
            className="flex items-center gap-1  duration-200 ease-in-out transition-all  hover:text-primary font-semibold text-xs bg-white px-4 py-3 rounded-full truncate"
          >
